								...
								<CardContent className="pt-6">
									<div className="text-center py-8">
										...
										<p className="text-gray-600 mb-4">
											You haven't booked any appointments. Start by booking your
											first appointment.
										</p>
										<Button
											...
											<div className="space-y-3 flex-1">
												<div className="flex items-center justify-between">
													<h3 className="font-semibold text-gray-900">
														{patientService.formatAppointmentType(
															appointment.type
														)}
													</h3>
													<Badge
														className={patientService.getStatusColor(
															appointment.status
														)}
														variant="secondary"
													>
														<div className="flex items-center space-x-1">
															...
															<span>
																{patientService.formatAppointmentStatus(
																	appointment.status
																)}
															</span>
														</div>
