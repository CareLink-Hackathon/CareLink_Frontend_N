	...
	const faqData = [
		{
			...
			answer:
				'You can book an appointment by going to the Appointments section and clicking "Book Appointment". Choose your preferred doctor, date, and time.',
		},
		{
			question: 'How can I access my medical records?',
			answer:
				'Your medical records are available in the Medical Records section. You can view, download, and share your records with healthcare providers.',
		},
		{
			question: 'How do I reschedule or cancel an appointment?',
			answer:
				'Go to your Appointments section, find the appointment you want to modify, and click the "Reschedule" or "Cancel" button.',
		},
		{
			question: 'How do I update my profile information?',
			answer:
				'Navigate to Settings > Profile to update your personal information, contact details, and preferences.',
		},
		{
			question: 'How do I enable notifications?',
			answer:
				'Go to Settings > Notifications to customize which alerts you want to receive and how you want to receive them.',
		},
		{
			question: 'Is my health data secure?',
			answer:
				'Yes, we use industry-standard encryption and security measures to protect your health information. Your data is HIPAA compliant.',
		},
	];
								...
								<div className="flex flex-col sm:flex-row items-center gap-4">
									...
									<div className="text-center sm:text-left flex-1">
										...
										<p className="text-sm text-red-600 mt-1">
											For medical emergencies, call 911 or go to your nearest
											emergency room
										</p>
									</div>
									<Button
