            ...
            <div className="mb-6">
              ...
              <Card className="bg-gradient-to-r from-blue-500 to-blue-600 text-white mb-6">
                <CardContent className="p-6">
                  ...
                  <p className="text-blue-100 mb-4">Monitor Hospital stats and performances</p>
                    ...
                    <div className="flex-1">
                      <Card className="bg-blue-600 text-white">
                        <CardContent className="p-4 text-center">
                          <h3 className="font-bold mb-2">Invite Other Admins</h3>
                          <p className="text-blue-100 text-sm mb-4">
                            Do you like what you see and how you manage the hospital?
                          </p>
                          <Button className="bg-white text-blue-600 hover:bg-gray-100">Add Admin</Button>
                        </CardContent>
                      </Card>
                    </div>
                  </div>
          ...
          {activeWorkersOpen && (
            <div className="w-80 bg-white border-l border-gray-200 p-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <Button variant="ghost" size="icon" onClick={() => setActiveWorkersOpen(false)}>
                  <X className="w-4 h-4" />
                </Button>
              </div>
                ...
                {workers.map((worker, index) => (
                  <div key={index} className="flex items-start space-x-3 p-3 rounded-lg hover:bg-gray-50">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-gray-600 mt-1 line-clamp-2">{worker.role}</p>
                    </div>
